...
import functional.monad.optionalexample.counter.Counter;
import functional.monad.optionalexample.counter.CounterRepo;
import functional.monad.optionalexample.counter.TotalCountsCalculator;
...
public class TotalCountsCalculatorTest {
    ...
    public void calculatesTotalCorrectly() {
        ...
        assertThat(calculator.totalColour(), is(Optional.of(7+5)));
