...
public class TestBulkInsert {
	...
	static final String JDBC_DRIVER="com.mysql.examples.persistence.jdbc.Driver";
	static final String SERVER_IP = "127.0.0.1";
	static final String DATABASE_NAME = "vision";	
	static final String URL = "examples.persistence.jdbc:mysql://"+SERVER_IP+"/"+DATABASE_NAME;
